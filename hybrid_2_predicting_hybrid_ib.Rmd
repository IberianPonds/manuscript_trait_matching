...
```{r}
#RandomForest only when RF>0.5 
# Use 0.5 threshold value for all interaction types
TR_all <- 0.5

hybrid_rf_interactions <- hybrid_interact_con_res_ib

### select predator interactions
hybrid_rf_interactions[hybrid_rf_interactions$con_feeding_type.predator==1 & hybrid_rf_interactions$pred1 >= TR_all,]$value <- 1
hybrid_rf_interactions[hybrid_rf_interactions$con_feeding_type.predator==1 & hybrid_rf_interactions$pred1 < TR_all,]$value <- 0

### select omnivore interactions
hybrid_rf_interactions[hybrid_rf_interactions$con_feeding_type.omnivore==1 & hybrid_rf_interactions$pred1 >= TR_all,]$value <- 1
hybrid_rf_interactions[hybrid_rf_interactions$con_feeding_type.omnivore==1 & hybrid_rf_interactions$pred1 < TR_all,]$value <- 0
  
### select herbivore interactions
hybrid_rf_interactions[hybrid_rf_interactions$con_feeding_type.herbivore==1 & hybrid_rf_interactions$pred1 >= TR_all,]$value <- 1
hybrid_rf_interactions[hybrid_rf_interactions$con_feeding_type.herbivore==1 & hybrid_rf_interactions$pred1 < TR_all,]$value <- 0
